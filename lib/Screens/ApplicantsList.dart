...
class _ApplicantListPageState extends State<ApplicantListPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Applicant List',style: TextStyle(color: Colors.black),),
  ...
  //                               child: Text(
  //                                 'Applied for $jobPosition $employmentType in $category sector at $companyName',
                ...
                Column(
                  ...
                  children: [
                    Row(
                      children: [
                        CircleAvatar(
                          backgroundImage: NetworkImage(imageUrl), // Use user's imageUrl
                          radius: 30,
                        ),
                        SizedBox(width: 16),
                        Expanded(
