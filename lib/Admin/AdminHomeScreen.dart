...
import 'package:gigs/Admin/AllJobs.dart';
import 'package:gigs/Admin/FeedbackListPage.dart';
import 'package:gigs/Admin/UsersList.dart';
...
class _AdminHomeScreenState extends State<AdminHomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor:  Color.fromARGB(255, 119, 94, 228),
      ),
      body: _buildPage(_selectedPageIndex),
      bottomNavigationBar: CurvedNavigationBar(
        index: _selectedPageIndex,
        height: 50,
        color:  Color.fromARGB(255, 119, 94, 228),
  ...
  Widget _buildPage(int index) {
    switch (index) {
      ...
      case 1:
        return UserListPage(currentUserEmail: widget.currentuserEmail);
      case 2:
        return AllJobsPage();
      case 3:
            ...
            children: [
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  primary:  Color.fromARGB(255, 119, 94, 228),
