...
class JobPositionSearchScreen extends StatefulWidget {
  @override
  _JobPositionSearchScreenState createState() =>
      _JobPositionSearchScreenState();
}

class _JobPositionSearchScreenState extends State<JobPositionSearchScreen> {
  final TextEditingController _searchController = TextEditingController();
  List<String> allJobPositions = [
    "accountant",
    "actor",
    "actuary",
  ...
  "AI Art Curator",
  "Digital Art Restoration Specialist",
  "Drone Cinematographer",
  "Astrobiologist",
  "Space Tourism Guide",
  "Zero Waste Consultant",
  "Circular Economy Strategist",
  "Blockchain for Social Impact Consultant",
  "Ethical Supply Chain Manager",
  "Digital Detox Coach",
  "Mindfulness App Developer",
  "Tech-Life Balance Consultant",
  "Personal Data Broker",
  "Quantified Self Consultant",
  "Self-Driving Car Fleet Manager",
  "Autonomous Vehicle Ethicist",
  "Neuro-Marketing Specialist",
  "Mind-Uploading Specialist",
  "Quantum Cryptographer",
  "Neuro-Technology Engineer",
  "Consciousness Researcher",
  "Post-Human Studies Researcher",
  "Human Augmentation Specialist",
  "Exoskeleton Engineer",
  "AI Emotion Analyst",
  "Cybernetic Implant Technician",
  "Space Weather Analyst",
  "Asteroid Miner",
  "Exoplanet Hunter",
  "Lunar Habitat Architect",
  "Interstellar Travel Coordinator"
  ];
  List<String> filteredJobPositions = [];
  String selectedJobPosition = ''; // To store selected job position

  @override
  void initState() {
    super.initState();
    _searchController.addListener(_onSearchChanged);
    filteredJobPositions = allJobPositions;
  }
  ...
  void setJobPosition(String position) {
    setState(() {
      ...
      _searchController.text = position; // Populate search field
    });
  }

  void selectJobPositionAndPop(String position) {
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'Search for a job position...',
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                final position = filteredJobPositions[index];
                return ListTile(
                  title: Text(position),
                  onTap: () {
                    selectJobPositionAndPop(position);
                  },
                );
              },
            ),
